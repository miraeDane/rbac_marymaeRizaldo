...
Route::get('/admin/manageUsers', [UserController::class, 'index'])->name('manageUsers');
Route::get('/admin/manageUsers/{id}/edit', [UserController::class, 'editUser'])->name('editUser');
Route::post('/admin/manageUsers/{id}/update', [UserController::class, 'updateUser'])->name('updateUser');
Route::delete('/admin/manageUsers/{id}', [UserController::class, 'deleteUser'])->name('deleteUser');
